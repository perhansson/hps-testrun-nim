...
$0.5$ and $\approx$4~GeV. It needs granularity and signal 
...
required only a single cluster in either the top or bottom ECal halves. It was tested to trigger rates 
...
These results show that we can operate with the six sample readout mode of the APV25 ASIC and 
