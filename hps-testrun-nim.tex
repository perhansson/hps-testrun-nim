...
that the trigger rates and occupancies are as expected. This paper describes the HPS Test Run apparatus 
...
The silicon tracking and vertexing detector for HPS Test Run, or SVT, resides in a vacuum 
...
The PS pair converter was located $\approx~77$~cm upstream of the first layer of the SVT.
 ...
 0.4-1.3$\times10^{8}$/s ($0.55<$E$_\gamma<5.5$~GeV) at beam currents varying between 
...
\end{center}
\end{table}
The photon beam line during the HPS Test Run produced a relatively large fraction of pairs 
...
The lead-tungstate (PbOW$_{4}$) crystal inner 
...
provide factor of $2333$ amplification of the APD signal.
