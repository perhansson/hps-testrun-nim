...
as a narrow \ee{}  mass peak above the trident background or as a narrow mass peak with a decay 
vertex displaced from the production target, so charged particle tracking and vertexing are needed for 
its detection. In the HPS Test Run, charged particles are measured
with a compact forward silicon microstrip tracker inside a dipole magnet. Electromagnetic 
...
the essentially 100\% duty cycle of the CEBAF accelerator.
\end{abstract}
...
499~MHz beam, at energies between 2.2 and 6.6~GeV and currents between 200 and 600~nA.  
...
System & Coverage & \# channels & ADC & Time resolution & \# layers & Segmentation & Performance \\
 & (mrad) &  & (bit) & (ns) &  &  &  \\
\hline
SVT & $15<\theta_{y} < 70$ & 12800 & 14 & $\approx 2$~ns & 5  & $\approx 120~\mu$m $r-\phi$ & $\sigma_{d0,y}  \approx 100~\mu$m \\
...
through the PS pair converter gold foil and later the HPS system as illustrated in 
...
The runs taken during the time dedicated to HPS Test Run is summarized in Tab.~\ref{tab:currents}.
