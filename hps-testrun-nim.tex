...
silicon \sep microstrip \sep tracking  \sep vertexing \sep heavy photon \sep dark photon \sep hidden sector \sep electromagnetic calorimeter
...
vertex signatures to search for \Aprime{}. It uses  a $\approx 1$~m long silicon tracking and 
vertexing detector
...
\begin{figure*}[t]
\begin{center}
    \includegraphics[width=0.8\textwidth]{figures/hps_testrun_rendering_2}
...
\hline
ECal & $15<\theta_{y} < 60$ & 442 & 12  & 1  & $1.33\times1.33$~cm$^2$ & 4  & $\sigma(E)/E \approx 4.5\%$ \\ 
 &  &  &   &  & $1.6\times1.6$~cm$^2$  & (trigger)&  \\ 

%SVT & $15<\theta_{y} < 70$ & 12780 & 14 & 5    & $\approx 120~\mu$m ($r-\phi$) & $\approx 2$& $\sigma_{d0,y}  \approx 100~\mu$m \\
...
%    \includegraphics[width=0.5\textwidth]{figures/HPS_dimensions}
    \includegraphics[width=0.45\textwidth]{figures/hps-testrun-beamline-edited3}
...
have momenta in the range of 1~GeV$/$c, so multiple scattering dominates mass and vertexing 
...
calorimeter of the CLAS detector~\cite{clas_ecal,clas_ecal2,clas_thesis}, in operation since 2005 in Hall B, meets 
...
\begin{center}
{\small
	\includegraphics[width=7cm]{figures/run1351_110513_samples_L1_top.pdf}
...
true pulse shape differing from our idealized fit function which will be improved in the future~\cite{Friedl2007385}. Reducing 
...
\begin{center}
{\small
	\includegraphics[width=7cm]{figures/run1351_time_residual_top_layer2.pdf}
	\caption{
...
\begin{center}
{\small
    	\includegraphics[width=7cm]{figures/single_hit_efficiency.pdf}
...
{\small
\begin{figure*}[t]
   \includegraphics[width=5cm]{figures/h_trk_top_px_h_trk_top_px_trigsel4hit_pair1351_twotrkfilt-v6-paper-mod}
   \includegraphics[width=5cm]{figures/h_invM_h_invM_trigsel4hit_pair1351_twotrkfilt-v6-paper-mod}
   \includegraphics[width=5cm]{figures/h_sumE_h_sumE_trigsel4hit_pair1351_twotrkfilt-v6-paper}
\caption{Kinematic distributions for \ee{} pairs selected by opposite charged tracks in the top and bottom half of the tracker: track momentum in the top half of the SVT (left), invariant mass (middle) and the sum of the track energy for the pair (right).}
\label{fig:pair_kin}
\end{figure*}
}
\end{center}
...
{\small
 ...
 \begin{center}
	...
	\includegraphics[width=7cm]{figures/h_trk_top_fr_conv_z_h_trk_top_conv_z_dataMC_twotrksel-mod}
	\includegraphics[width=7cm]{figures/h_trk_top_fr_conv_y_h_trk_top_conv_y_dataMC_twotrksel-mod}
